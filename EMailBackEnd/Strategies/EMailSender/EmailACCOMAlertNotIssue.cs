...
{
    public class EmailACCOMAlertNotIssue : EMailSenderDefault
    {
        protected override void CompleteDto(DTO.AbstractEMailDTO dto)
        {
            dto.TemplateType = TemplateTypeHome.Get("ACCOMNOTISSUE");
        }
        ...
        {
            string xml = SerializeObject((EmailAlertNotIssueDTO)dto);
