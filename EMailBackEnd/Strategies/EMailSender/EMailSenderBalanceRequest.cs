...
{
    class EMailSenderBalanceRequest : EMailQuote
    {
        protected override void CompleteDto(AbstractEMailDTO dto)
        {
            BalanceRequestDTO balanceRequest = (BalanceRequestDTO)dto;
            dto.TemplateType = TemplateTypeHome.Get("BALANCEREQUEST");
        }
        ...
        protected override void Proccess(AbstractEMailDTO dto, Template template, EMailLog log)
        {
            ...
            try
            {
                    ...
                    if (template.Id != 0)
                    {
                        ...
                        dto.CountryName = country.Nombre;
        ...
        protected override string ProccessContextData(AbstractEMailDTO dto, string body)
        {
            ...
            string xml = SerializeObject((BalanceRequestDTO)dto);
