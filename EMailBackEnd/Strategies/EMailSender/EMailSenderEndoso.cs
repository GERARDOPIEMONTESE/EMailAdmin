...
{
    public class EMailSenderEndoso : EMailSenderDefault
    {
        protected override void CompleteDto(AbstractEMailDTO dto)
        {
            ServiceLocator.Instance().GetSendMailEndosoServices().CompleteInformation(dto);            
        }
        ...
        {
            string xml = SerializeObject((EmailEndosoDTO)dto);
        ...
        {
            EmailEndosoDTO ekitDto = (EmailEndosoDTO)dto;
