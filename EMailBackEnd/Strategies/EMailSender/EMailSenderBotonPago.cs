...
{
    public class EMailSenderBotonPago : EMailSenderDefault
    {
        protected override void CompleteDto(AbstractEMailDTO dto)
        {
            ServiceLocator.Instance().GetSendMailBotonPagoServices().CompleteInformation(dto);            
        }
        ...
        {
            string xml = SerializeObject((EmailBotonPagoDTO)dto);
