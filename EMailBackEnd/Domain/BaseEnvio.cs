...
{
    public class BaseEnvio : ObjetoNegocio
    {
        private const string NAME = "BaseEnvio";
        ...
        public bool bEliminar { get; set; } //indica si hay que eliminar el registro despues de enviar el mail

        #endregion

        public override FrameworkDAC.Dato.IDAOObjetoNegocio ObtenerDAO()
        {
            return DAOLocator.Instance().GetDAONiceTrip();
        }
