...
{
    public partial class AttachmentList : CustomPage
    {
        #region Constructor
        ...
        protected void GrvAttachmentRowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Edit")
            {
                ...
                Response.Redirect("AttachmentInformation.aspx?IdAttachment=" + id);
            }
        }
        ...
        protected void btnNew_OnClick(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AttachmentInformation.aspx");
        }
        ...
        private void Bind()
        {
            grvAttachment.DataSource = AttachmentHome.FindByFilters(
                Convert.ToInt32(ddlType.SelectedValue), Convert.ToInt32(ddlEstrategy.SelectedValue), txtName.Text, true);
