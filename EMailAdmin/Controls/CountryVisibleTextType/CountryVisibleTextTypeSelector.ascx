<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CountryVisibleTextTypeSelector.ascx.cs" Inherits="EMailAdmin.Controls.CountryVisibleTextType.CountryVisibleTextTypeSelector" %>
<div>
    <fieldset>
