<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SignatureSelector.ascx.cs" Inherits="EMailAdmin.Controls.Selectors.Signature.SignatureSelector" %>

<div class="formModule">
    <fieldset>
        <div class="module">
            <asp:Label runat="server" ID="lblSignature" Text="Signature" 
                CssClass="labelTitle" meta:resourcekey="lblSignatureResource1" />
            <p/>
            <br/>
        </div>
        <div class="module">
