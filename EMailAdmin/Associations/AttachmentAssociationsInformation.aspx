<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttachmentAssociationsInformation.aspx.cs" Inherits="EMailAdmin.Associations.AttachmentAssociationsInformation" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
            ...
            <div>
                ...
                <asp:Panel runat="server" CssClass="modalBackgroundRestore" Style="display: none;" ID="pnlGroup">
                    <div class="formModule">
                        <fieldset>
                            <div class="module">
                                <grp:GroupViewer ID="grpGroup" runat="server" OnButtonAddAttachmentPressed="AddAttachmentAssociations" OnButtonDelAttachmentPressed="DelAttachmentAssociations" />
                                ...
                                <asp:Button runat="server" ID="btnCancelGroupViewer" CssClass=" cancel" Text="Cancel" OnClick="BtnCancelGroupViewerClick" meta:resourcekey="btnCancelResource1"/>
                            </div>
                        </fieldset>     
                    </div>              
                </asp:Panel>
