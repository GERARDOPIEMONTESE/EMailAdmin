<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CountryVisibleTextList.aspx.cs" Inherits="EMailAdmin.CountryVisibleText.CountryVisibleTextList" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CountryVisibleText List</title>
            ...
            <div class="gridList">
                <div class="gridFont">
                    <asp:GridView 
                        ...
                        OnRowCommand="GrvCountryVisibleTextRowCommand"
                        OnRowDataBound="GrvCountryVisibleTextRowDataBound"
                        OnPageIndexChanging="GrvCountryVisibleTextPageIndexChange" meta:resourcekey="grvCountryVisibleTextResource1" 
                        >
                        <Columns>
                            ...
                            <asp:BoundField DataField="CountriesDescription" HeaderText="Countries"
                                meta:resourcekey="BoundFieldResource3" >
                            <ItemStyle Width="250px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="CountryVisibleTextTypesDescription" HeaderText="CountryVisibleText Type"
