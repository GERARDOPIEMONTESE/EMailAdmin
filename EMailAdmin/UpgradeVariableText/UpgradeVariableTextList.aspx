<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpgradeVariableTextList.aspx.cs" Inherits="EMailAdmin.UpgradeVariableText.UpgradeVariableTextList" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
            ...
            <div class="gridList">
                <div class="gridFont">
                    <asp:GridView 
                        ...
                        OnRowCommand="GrvUpgradeVariableTextRowCommand"
                        OnRowDataBound="GrvUpgradeVariableTextRowDataBound"
                        OnPageIndexChanging="GrvUpgradeVariableTextPageIndexChange" meta:resourcekey="grvUpgradeVariableTextResource1" 
                        >
                        <Columns>
                            ...
                            <asp:BoundField DataField="UpgradeDesription" HeaderText="Countries"
                                meta:resourcekey="BoundFieldResource3" >
                            <ItemStyle Width="250px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="UpgradeVariableTextTypesDescription" HeaderText="UpgradeVariableText Type"
