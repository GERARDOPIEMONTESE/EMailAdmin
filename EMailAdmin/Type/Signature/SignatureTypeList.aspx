<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignatureTypeList.aspx.cs" Inherits="EMailAdmin.Type.Signature.SignatureTypeList" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Signature Type List</title>
            ...
            <div class="gridList">
                <div class="gridFont">
                    <asp:GridView 
                        ...
                        OnRowCommand="GrvSignatureTypeRowCommand"
                        OnRowDataBound="GrvSignatureTypeRowDataBound"
                        OnPageIndexChanging="GrvSignatureTypePageIndexChange" 
                        meta:resourcekey="grvSignatureTypeResource1" >
                        <Columns>
