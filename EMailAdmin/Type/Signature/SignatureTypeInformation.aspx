<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignatureTypeInformation.aspx.cs" Inherits="EMailAdmin.Type.Signature.SignatureTypeInformation"  meta:resourcekey="PageResource1" uiculture="auto" %>
            ...
            <div class="formModule">
                ...
                <div class="module">
                    <asp:Button runat="server" ID="btnAccept" Text="Aceptar" CssClass="button ok" 
                        OnClick="BtnAcceptOnClick" ValidationGroup="SignatureType" 
