<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CountryVisibleTextTypeInformation.aspx.cs" Inherits="EMailAdmin.Type.CountryVisibleText.CountryVisibleTextTypeInformation" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
            ...
            <div class="formModule">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:RequiredFieldValidator runat="server" ID="rfvCode" ControlToValidate="txtCode" 
                                        ErrorMessage="   *" ValidationGroup="CountryVisibleTextType" 
                                        meta:resourcekey="rfvCodeResource1" />
                                </td>
                                <td>
                                    <asp:CustomValidator runat="server" ID="ctmCode" ErrorMessage="   *" 
                                    ValidationGroup="CountryVisibleTextType" Display="Dynamic" 
                ...
                <div class="module">
                    <asp:Button runat="server" ID="btnAccept" Text="Aceptar" CssClass="button ok" 
                        OnClick="BtnAcceptOnClick" ValidationGroup="CountryVisibleTextType" 
