<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CountryVisibleTextTypeList.aspx.cs" Inherits="EMailAdmin.Type.CountryVisibleText.CountryVisibleTextTypeList" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>CountryVisibleText Type List</title>
            ...
            <div class="gridList">
                <div class="gridFont">
                    <asp:GridView 
                        ...
                        OnRowCommand="GrvCountryVisibleTextTypeRowCommand"
                        OnRowDataBound="GrvCountryVisibleTextTypeRowDataBound"
                        OnPageIndexChanging="GrvCountryVisibleTextTypePageIndexChange" 
                        meta:resourcekey="grvCountryVisibleTextTypeResource1" >
                        <Columns>
